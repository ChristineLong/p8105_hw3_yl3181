...
-   In 2002, states observed at 7 locations is CT, FL; (Comment: This means that the response rate for overall health topics are relatively high in these two states in 2002.)
...
```
    ...
    ## # A tibble: 3 x 3
    ##    year mean_prop_resp sd_prop_resp
    ##   <int>          <dbl>        <dbl>
    ## 1  2002          0.326       0.0894
    ## 2  2006          0.338       0.0121
    ## 3  2010          0.300       0.182
